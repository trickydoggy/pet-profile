...
import { X, Mail, Phone, Instagram, MapPin, ShieldAlert, Copy, Check } from 'lucide-react';
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between shadow-lg hover:border-cyan-400/30 transition-all">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xs text-white/50 font-semibold block">E-mail</span>
                <a
            ...
            <button
              onClick={() => copyToClipboard(BUDDY_PROFILE.humans.email, 'email')}
          ...
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between shadow-lg hover:border-rose-400/30 transition-all">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xs text-white/50 font-semibold block">Aventuras no Instagram</span>
            ...
            <button
              onClick={() => copyToClipboard(BUDDY_PROFILE.humans.instagram, 'ig')}
              className="p-2 rounded-lg text-white/70 hover:text-white hover:bg-white/10 transition-colors"
            >
              {copiedField === 'ig' ? (
                <Check className="w-4 h-4 text-emerald-400" />
